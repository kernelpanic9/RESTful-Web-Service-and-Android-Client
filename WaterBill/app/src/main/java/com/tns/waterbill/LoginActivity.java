...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            Log.i("xxxxxx", mEmailView.getText().toString());
    ...
    private void authenticate( String username, String password ){
        ...
        try {
            ...
            URI website = new URI("http://192.168.43.133:8080/RESTfullWebService/rest/auth/new/" + username + "/" + password);
            ...
            if( sessionId.contains("failure") ){
                Log.i("***********", "Error in authenticate");
                ...
                db.execSQL("insert into auth values('" + username + "', '" + sessionId + "')");
